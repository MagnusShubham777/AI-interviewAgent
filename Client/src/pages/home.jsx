            ...
            <div className="flex-1 px-6 py-20">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center gap-10 mb-28">
                            ...
                            [
                                {
                                    ...
                                    desc: "AI adjusts diffculty based on selected job role."
                                },
                                {
                                    icon: <BsMic size={24} />,
                                    step: "STEP 2",
                        ...
                        ${index == 2 ? "rotate=[-3deg]" : ""}
                        `}>
                                    <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-green-500 text-green-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg">{items.icon}
                                    </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-10">{
                            [
                                ...
                                },
                                {
                                    ...
                                    desc: "Projext specific questions based on uploaded resume."

                                },
                                {
                                    image: pdfImg,
                                    icon: <BsFileEarmarkText size={20} />,
                                    title: "Downloadable PDF format",
                        ...
                        <div className="grid md:grid-cols-2 gap-6">{
                            [
                                ...
                                },
                                {
                                    ...
                                    desc: "Basic tone and white analysis insight."
                                },
                                {
                                    img: creditImg,
                                    title: "Credit System",
